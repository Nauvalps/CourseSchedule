...
class CourseViewHolder(view: View): RecyclerView.ViewHolder(view) {
    private val textCourse: TextView = view.findViewById(R.id.tv_course)
    private val textDay: TextView = view.findViewById(R.id.tv_time)
    private val textLecturer: TextView = view.findViewById(R.id.tv_lecturer)
    ...
    fun bind(course: Course, clickListener: (Course) -> Unit) {
        ...
        course.apply {
            ...
            textDay.text = timeFormat
            textLecturer.text = lecturer
