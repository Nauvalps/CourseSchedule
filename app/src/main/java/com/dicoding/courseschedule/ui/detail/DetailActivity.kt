...
class DetailActivity : AppCompatActivity() {
    ...
    private lateinit var textLecturer: TextView
    private lateinit var textNote: TextView

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_detail)
        textCourse = findViewById(R.id.tv_course_name)
        textTime = findViewById(R.id.tv_time)
        textLecturer = findViewById(R.id.tv_lecturer)
        textNote = findViewById(R.id.tv_note)
